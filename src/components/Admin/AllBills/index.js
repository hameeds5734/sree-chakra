...
const AllBills = () => {
  ...
  const Update_Payment = () => {
    ...
    useEffect(()=>{
      setCurrentMenuName('All Bills');
    },[])
    
    const searchBill = () => {
      setFileName('SCSAppServiceBills'+ new Date())
      axios.post(AllServices.SEARCH_BILLS(), { date1:date1, date2:date2, searchText:searchText, searchType:searchType }).then(response=>{
      ...
      >
        ...
        <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          ...
          <Grid item xs={1} sm={1} md={1} lg={1} style={{display:'flex',paddingTop:20}}>
              <b style={{color:'#666',fontWeight:'bold'}}>No </b>
          </Grid>
          <Grid item xs={6} sm={6} md={6} lg={6} style={{display:'flex',paddingTop:20}}>
              <b style={{color:'#666',fontWeight:'bold'}}>Machine Name </b>
          </Grid>
          <Grid item xs={5} sm={5} md={5} lg={5} style={{display:'flex',paddingTop:20}}>
              <b style={{color:'#666',fontWeight:'bold'}}>Part No </b>
          </Grid>
          <Grid item xs={12} sm={12} md={12} lg={12}>
            <Divider style={{backgroundColor:'#ddd'}} />
          </Grid>
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        ...
        <Grid item sm={12} xs={12} lg={12}>
          ...
          <Grid xs={12} md={12} lg={12} item style={{textAlign:'center'}}>
                <b style={{borderStyle:'solid',padding:10,borderWidth:1,borderRadius:10}}>All Service Bills</b>
                <br/>
                <br/>
            </Grid>
